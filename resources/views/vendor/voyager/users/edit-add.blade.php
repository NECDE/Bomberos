...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' Bombero ' }}
    </h1>
@stop
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="rut" name="rut" placeholder="Rut"
                                       value="@if(isset($dataTypeContent->rut)){{ $dataTypeContent->rut }}@endif">
                            </div>
                            ...
                            @endcan
                             ...
                             <div class="form-group">
                                    <label for="default_role">Cargo</label>
                                    @php
                                        $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};

                                        $row     = $dataTypeRows->where('field', 'user_belongsto_cargo_relationship')->first();
                                        $options = $row->details;
                                    @endphp
                                    @include('voyager::formfields.relationship')
                                </div>
